...
const DropdownPopover = (props: DropdownPopoverProps) => {
    return (
        <AriaPopover
            ...
            className={(state) =>
                cx(
                    "w-62 origin-(--trigger-anchor-point) overflow-auto rounded-sm bg-primary shadow-sm ring-1 ring-secondary_alt will-change-transform",
                    state.isEntering &&
...
const DropdownDotsButton = (props: AriaButtonProps & RefAttributes<HTMLButtonElement>) => {
    return (
        <AriaButton
            ...
            className={(state) =>
                cx(
                    "cursor-pointer rounded-sm text-fg-quaternary outline-focus-ring transition duration-100 ease-linear",
