...
export const tenantColumns: HawkeyeColumn<Tenant>[] = withIcons([
  ...
  { key: 'tenant_lifecycle', label: 'Stage', type: 'enum', width: 120 },
...
export const tenantFieldGroups: FieldGroup<Tenant>[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'preferred_furnished_type', label: 'Furnished Type', type: 'enum' },
      { key: 'preferred_move_in_timeline', label: 'Move-in Timeline', type: 'enum' },
      { key: 'gender_preferences', label: 'Gender Preferences', type: 'enum' },
      { key: 'food_preferences', label: 'Food Preferences', type: 'enum' },
      { key: 'has_pet', label: 'Has Pet', type: 'boolean' },
      { key: 'smoking_preferences', label: 'Smoking', type: 'enum' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'visit_outcome', label: 'Visit Outcome', type: 'enum' },
...
export const merchantColumns: HawkeyeColumn<Merchant>[] = withIcons([
  ...
  { key: 'deal_stage', label: 'Deal Stage', type: 'enum', width: 130 },
  { key: 'email', label: 'Email', type: 'email', width: 200 },
...
export const merchantFieldGroups: FieldGroup<Merchant>[] = [
  ...
  },
  {
    ...
    fields: [
      { key: 'disqualification_reason', label: 'Disqualification Reason', type: 'enum' },
      { key: 'lost_reason', label: 'Lost Reason', type: 'longtext' },
      { key: 'landlord_personality', label: 'Landlord Personality', type: 'enum' },
...
export const vendorFieldGroups: FieldGroup<Vendor>[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'ifsc_code', label: 'IFSC Code' },
      { key: 'msme_vendor', label: 'MSME Vendor', type: 'enum' },
...
export const propertyColumns: HawkeyeColumn<Pid>[] = withIcons([
  ...
  { key: 'deal_stage', label: 'Deal Stage', type: 'enum', width: 120 },
]);
...
export const propertyFieldGroups: FieldGroup<Pid>[] = [
  ...
  },
  {
    label: 'Lead Stage',
    fields: [
      { key: 'deal_type', label: 'Deal Type', type: 'enum' },
      { key: 'units_count', label: 'Units Count', type: 'number' },
      { key: 'apartment_count', label: 'Apartment Count', type: 'number' },
      { key: 'property_type_lead', label: 'Property Type (Lead)', type: 'enum' },
      { key: 'furnishing_lead', label: 'Furnishing (Lead)', type: 'enum' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'payment_collection', label: 'Payment Collection', type: 'enum' },
...
export const contractColumns: HawkeyeColumn<Contract>[] = withIcons([
  ...
  { key: 'agreement_lifecycle', label: 'Agreement', type: 'enum', width: 120 },
]);
...
export const contractFieldGroups: FieldGroup<Contract>[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'increment_frequency', label: 'Increment Frequency', type: 'enum' },
    ],
  },
  {
    label: 'Lifecycle',
    fields: [
      ...
      { key: 'agreement_status', label: 'Agreement Status (Merchant)', type: 'enum' },
      { key: 'fmr_status', label: 'FMR Status', type: 'enum' },
      { key: 'deposit_paid_status', label: 'Deposit Paid Status', type: 'enum' },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'payment_cycle', label: 'Payment Cycle', type: 'enum' },
...
export const transactionColumns: HawkeyeColumn<Transaction>[] = withIcons([
  ...
  { key: 'purpose_category_2', label: 'Sub-category', type: 'enum', width: 120 },
...
export const transactionFieldGroups: FieldGroup<Transaction>[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'cost_revenue_center', label: 'Cost / Revenue Center', type: 'enum' },
    ],
  },
  {
    label: 'Parties',
...
export const itemColumns: HawkeyeColumn<Item>[] = withIcons([
  ...
  { key: 'qa_flag', label: 'QA', type: 'enum', width: 80 },
...
export const overheadFieldGroups: FieldGroup<Overhead>[] = [
  ...
  },
  {
    ...
    fields: [
      { key: 'purifier_type', label: 'Type', type: 'enum' },
